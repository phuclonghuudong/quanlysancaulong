 ...
 * @author phucp
 */
public final class NhanVien extends JPanel implements ActionListener, ItemListener {
...
//    IntegratedSearch search;
    ...
    public void initComponent() {
        ...
        String[] methodNames = {"getManhanvien", "getHoten", "getEmail", "getSodienthoai", "getVaitro", "isGioitinh", "getNgaysinh", "getTrangthai"};
...
//        });
    ...
    public void loadDataTable(ArrayList<NhanVienDTO> result) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            tblModel.addRow(new Object[]{
                ...
                result.get(i).getVaitro(),
                gioiTinh,
                result.get(i).getNgaysinh(),
                trangThai
            });
        };
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == mainFunction.btn.get("create")) {
            ...
            if (index != -1) {
                NhanVienDialog khDialog = new NhanVienDialog(this, owner, "Chỉnh sửa nhân viên", true, "update", listDS.get(index));
            }
            ...
            if (index != -1) {
                ...
                if (input == 0) {
                    boolean deleted = nvBUS.delete(listDS.get(index));
                    if (deleted) {
                        listDS = nvBUS.getAll();
                        loadDataTable(listDS);
                    } else {
            ...
            int index = getRowSelected();
            if (index != -1) {
                NhanVienDialog khDialog = new NhanVienDialog(this, owner, "Xem nhân viên", true, "view", listDS.get(index));
            }
